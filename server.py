...
if __name__ == "__main__":
    # Browser-first local desktop mode.
    # This avoids the pywebview dependency and opens LiteTube in the
    # user default browser after Flask is ready.
    ...
    for _ in range(50):
        try:
            with socket.create_connection((APP_HOST, APP_PORT), timeout=0.15):
                break
        except OSError:
            _time.sleep(0.1)
